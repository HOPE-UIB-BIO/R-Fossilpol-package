    ...
    if(pollen_grain_test == TRUE){
      ...
      count_pollen <-
        function(x){
          ...
          if (!exists("n_pollen", envir = current_env)) {
            n_pollen <- NA
          }
      ...
      } else if(n_pollen_original != n_pollen_harm){
      ...
      if(
        ...
        if(n_pollen_harm_delete != n_pollen_harm_NA){
          usethis::ui_info(
            x = paste0(
              " - ",
      ...
      if(
        ...
        if(n_pollen_harm_delete != n_pollen_harm){
          usethis::ui_info(
            x = paste0(
              " - ",
