  ...
  function(selected_file,
      ...
      author_sheet <-
        ...
        dplyr::mutate(
          ...
          author_id = ifelse(
            ...
            paste0(
              formatC(n_author_id + order - n_authors_present,
                width = 3,
                flag = 0
              ),
              "_",
        ...
        if (
          ...
          for (l in 1:nrow(database_info)) {
            database_info_selected <-
              database_info[l, ] %>%
              dplyr::select(
                Company, BusinessStreet1, BusinessStreet2,
      ...
      affiliation_sheet <-
        ...
        dplyr::mutate(
          ...
          affiliation_id = ifelse(
            ...
            paste0(
              formatC(n_affiliations_id + order - n_aff_present,
                width = 3,
                flag = 0
              ),
              "_",
    ...
    if (
      ...
      datasets_id_table <-
        ...
        dplyr::mutate(
          dataset_id = paste0(
            formatC(n_datasets_id + dplyr::row_number(),
              width = 3,
              flag = 0
            ),
            "_",
