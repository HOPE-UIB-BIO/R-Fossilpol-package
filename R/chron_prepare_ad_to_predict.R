...
chron_prepare_ad_to_predict <-
  function(data_source, 
    ...
    if(current_state$setting_state == "FALSE-FALSE") {
      ...
      if(current_state$latest_ad_present == "TRUE-TRUE"){
    ...
    } else if(current_state$setting_state == "FALSE-TRUE") {
    ...
    } else if(current_state$setting_state == "TRUE-TRUE") {
      ...
      if(stringr::str_detect(current_state$latest_ad_present, "TRUE-*")) {
    ...
    } else if (current_state$setting_state == "TRUE-FALSE"){
